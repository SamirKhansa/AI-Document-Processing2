  ...
  return (
    <div className="flex flex-col min-h-screen bg-[var(--color-midnight-black)] text-white">
      ...
      <header className="px-4 sm:px-6 py-4 border-b border-white/10 backdrop-blur-xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <h1 className="text-lg sm:text-xl font-bold truncate">
            ...
            <span className="text-[var(--color-violet-blue)] ml-2">
              #{currentIndex + 1}
            </span>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              onClick={() => navigate("/")}
              className="px-4 py-2 rounded-xl bg-[var(--color-core-indigo)] hover:bg-[var(--color-core-indigo)]/80 flex items-center gap-2"
            >
      ...
      <div className="flex flex-col lg:flex-row flex-1 gap-4 p-4 sm:p-6 overflow-hidden">
        {/* RESULTS / DATA PANEL (first on mobile) */}
        <div className="order-1 lg:order-2 w-full lg:w-[420px] border border-white/10 rounded-3xl shadow-xl overflow-hidden flex flex-col">
          <div className="px-4 py-3 border-b border-white/10 flex items-center gap-2 text-white/70 sticky top-0 bg-[var(--color-midnight-black)] z-10">
            <Database size={18} />
            AI Extraction
          </div>
        ...
        {/* PREVIEW (second on mobile) */}
        <div className="order-2 lg:order-1 flex flex-col flex-1 border border-white/10 rounded-3xl shadow-xl overflow-hidden">
          <div className="flex-1 max-h-[300px] lg:max-h-none flex items-center justify-center p-4 overflow-hidden">
            {currentDoc?.file ? (
